...
> 마지막 업데이트: 2026-05-22 (v3 manifest 재생성 직후)
...
### v3 (예정, 2026-05-22 manifest 재생성 완료)
...
- 예상 best val/loss/total ≈ 0.86~0.87
...
- [ ] **약한 분류 헤드** (wrinkle_grade 1.27, skin_type 1.52, sensitive 0.63) — class_weights 로 해결 안 됨. v4 후보: focal loss / head 별 lr 차등 / 데이터 증강 부위별 차등
